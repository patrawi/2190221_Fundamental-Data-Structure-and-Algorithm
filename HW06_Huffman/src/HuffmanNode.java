public class HuffmanNode implements Comparable {
	...
	public static HuffmanNode buildHuffmanTree(Heap h) throws Exception {
		...
		HuffmanNode l = null;
		while(h.size() != 1) {
			HuffmanNode node1 =   (HuffmanNode) h.top();
			System.out.println(node1.frequency);
			 h.pop();
			 HuffmanNode node2 = (HuffmanNode) h.top();
			 System.out.println(node2.frequency);
			 h.pop();
			 l = new HuffmanNode(node1.frequency + node2.frequency,' ', node1, node2);
			 h.add(l);
		}
